 ...
 <table width="350" border="1" align="left" cellpadding="1" class="ui-corner-all" >
  <tr>
    <td width="355" class="ui-jqgrid-titlebar ui-widget-header ui-corner-top ui-helper-clearfix "><table width="100%" border="1" align="center" cellpadding="1" class="ui-corner-all">
      <tr >
        ...
        <td class="ui-widget-content"><input name="loginanula" type="text" id="loginanula" class="ui-widget-content ui-corner-all"  /><input name="idplanill" type="hidden" id="idplanill" value="<?php echo $id_planilla  ?>" /><input name="num_planilla" type="hidden" id="num_planilla" value="<?php echo $numplanilla  ?>" /></td>
      ...
      <tr class="ui-jqgrid-titlebar ui-widget-header ui-corner-top">
        ...
        <td class="ui-widget-content"><input name="passanula" type="password" id="passanula" class="ui-widget-content ui-corner-all"  /></td>
      ...
      <tr>
        <td class="ui-widget-content" colspan="2"><div align="center">
          <textarea name="observaciones_anula_p" id="observaciones_anula_p" cols="44" rows="3"></textarea>
        </div></td>
      </tr>
    </table></td>
  </tr>
  ...
  <tr>
    <td><table width="300" border="0" align="center" cellpadding="0">
      <tr>
        <td><div align="center">
          <input  type="button" class="fm-button ui-state-default ui-corner-all fm-button-icon-left"  id="grabaauto"  onclick="acepta_descarta('grabanula')" value="Aceptar"  />
        </div></td>
       <!-- <td><div align="center">
        ...
        <td><div align="center">
          <input  type="button" id="trigger2" name="trigger2" class="fm-button ui-state-default ui-corner-all fm-button-icon-left" value="Salir" onClick="javascript:jQuery('#descarta_planilla').dialog( 'close' );" />
        </div></td>
      </tr>
    </table></td>
  </tr>
