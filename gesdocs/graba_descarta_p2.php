...
$actutar="update planilla set estado=4 where id_planilla=$id_planilla";
...
<div class='ui-state-error' id='errorgraba' title='Grabar Recibido de Planilla'>
		<span class='ui-icon ui-icon-alert' style='float:left; margin:0 7px 50px 0;'></span>
	   Planilla de Viaje Ocasional Nº $numplanilla  Descartada con exito </div><script language='javascript'>
