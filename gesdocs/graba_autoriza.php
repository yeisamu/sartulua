	...
	if($numregistros>0)
	 {
		 //create the session variables
		  ...
		  $insertcomp="insert into `comprobante` (`fecha_ante`,`fecha_nu`, `usuario`, `fecha_alavo`, `id_comprobante`, `id_tran`,observaciones) values ('$fecha_ant','$fnew','$username','$fechact','$ntarjeta','$id_tran','AUTORIZADA') ";
...
<div class='ui-state-error' id='errorgraba' title='Advertencia'>
		<span class='ui-icon ui-icon-alert' style='float:left; margin:0 7px 50px 0;'></span>
	   Tarjeta de control # $ntarjeta  Autorizada con exito  </div><script language='javascript'>
