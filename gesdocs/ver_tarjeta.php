...
$selhizo=mysql_query("select * from comprobante where id_comprobante=".$id_tarjeta);
$seldata=mysql_fetch_array($selhizo);
  ...
  <tr>
    <td class="ui-jqgrid-titlebar ui-widget-header ui-corner-all ui-helper-clearfix "><table width="655" border="0" align="center" cellspacing="5">
      <tr class="ui-widget-header" >
        <td width="106" rowspan="4" ><img src="../fotos/<?php echo $filatar['codigo'];?>.jpg" width="104" height="120"  /></td>
        <td width="190" ><div align="center" >Documento</div></td>
...
?>	
		...
		<td width="160" class="Estilo3"><?php echo $condu['documento'] ?></td>
		<td width="160" class="Estilo3"><?php echo $condu['numero'] ?></td>
		<td width="160" class="ui-widget-content"><?php echo $condu['eps'] ?></td>
		<td width="89" class="Estilo3"><?php echo deme_f_detallecon($id_tarjeta,$condu['id_doc']); ?></td>
		
		<td width="105" class="Estilo3"><?php echo $condu['fecha_vence']; ?>
...
// $dias= (int) $can_dias; 	
 ...
 $fecha_ok=date("Y-m-d", $calculo);
	...
	echo $fecha_ok;$fvigencia=$fecha_ok ?></td><div  id="idiario"></div><input type="hidden" id="diariosv" name="diariosv"  value="<?php echo $filatar['id_movil']?>" class="ui-widget-content ui-corner-all"  /><input type="hidden" id="fvencediario" name="fvencediario"  value="<?php echo $fecha_ok?>" class="ui-widget-content ui-corner-all"  />
      </tr>
    </table></td>
  </tr>
 <!-- <tr>
...
?>	
         <tr class="ui-widget-content">
		<td width="55"><span class="Estilo3"><?php echo $condu['id_documento'] ?>
		    <input type="hidden" name="idvdoc<?php echo $i?>" value="<?php echo $condu['id_documento'];?>" />
		</span></td>
		<td width="181" class="Estilo3"><?php echo $condu['descripcion'] ?></td>
		<td width="160" class="Estilo3"><?php echo $condu['numero'] ?></td>
		<td width="88" class="Estilo3"><?php echo deme_f_detalle($id_tarjeta,$condu['id_documento']); ?></td>
		
		<td width="93" class="Estilo3"><?php echo $condu['fecha_ven']; ?>
 ...
 <!-- <tr>
  ...
  <tr >
    <td class="ui-jqgrid-titlebar ui-widget-header ui-corner-all ui-helper-clearfix "><table width="500" border="0" align="center" cellspacing="5">
      ...
      <tr>
        ...
        <td class="ui-widget-content"><?php echo $seldata['usuario'];?></td>
        <td class="ui-widget-content"><?php echo $seldata['fecha_alavo'];  ?></td>
      </tr>
	   <tr class="ui-widget-header" >
  ...
  <tr>
    <td class="ui-corner-all"><table width="493" border="0" cellspacing="5">
      <tr>
         <td width="100%">
          <input type="hidden" name="grabaimp" id="grabaimp"  value="Guardar"  class="fm-button ui-state-default ui-corner-all fm-button-icon-left" onclick="grabactu('grabatc')" />
       
          <input type="hidden" name="buttonc" value="Cancelar" class="fm-button ui-state-default ui-corner-all fm-button-icon-left" onclick="javascript:jQuery('#actualizatc').dialog( 'close' );" />
        
       
          
            <div align="center">
              <input type="button" name="cancelatc" value="Salir"  class="fm-button ui-state-default ui-corner-all fm-button-icon-left"onclick="javascript:jQuery('#vertc').dialog( 'close' );" />
          </div></td></tr>
    </table></td>
  </tr>
</table>
