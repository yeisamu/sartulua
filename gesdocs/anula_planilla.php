 ...
 <table width="350" border="1" align="left" cellpadding="1" class="ui-corner-all" >
  ...
  <tr>
    <td><table width="300" border="0" align="center" cellpadding="0">
      <tr>
        <td><div align="center">
          <input  type="button" class="fm-button ui-state-default ui-corner-all fm-button-icon-left"  id="grabaauto"  onclick="acepta_anula('grabanula')" value="Aceptar"  />
        </div></td>
       <!-- <td><div align="center">
        ...
        <td><div align="center">
          <input  type="button" id="trigger2" name="trigger2" class="fm-button ui-state-default ui-corner-all fm-button-icon-left" value="Salir" onClick="javascript:jQuery('#anula_planilla').dialog( 'close' );" />
        </div></td>
      </tr>
    </table></td>
  </tr>
