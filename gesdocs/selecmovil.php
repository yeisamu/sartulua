...
array_push($items,array("id"=>$i,"label"=>$fila["id_movil"].'-'.$fila["placa"],"value"=>$fila["id_movil"],"placa" => $fila["placa"],"marca" => $fila["referencia"],"modelo" => $fila["modelo"],"vigencia" =>$fecha_ok ));
