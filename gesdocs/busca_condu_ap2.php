...
$select = mysql_query("select * from conductor where apellido2 like '%$cadena%'");
...
array_push($items,array("id"=>$i,"label"=>utf8_encode($fila["apellido2"]).' '.utf8_encode($fila["apellido1"]).' '.utf8_encode($fila["nombre1"]),"value"=>utf8_encode($fila["apellido2"]), ));
