...
///bussqueda
 ...
 { case 1:
 $mes=date('m');
  $result = mysql_query("SELECT COUNT(*) AS count from planilla inner join tarjeta_control on planilla.id_tarjeta=tarjeta_control.id_tarjeta where planilla.estado <= 3  and id_movil=".$id.$wh1);
...
WHERE planilla.estado <=3 and id_movil=".$id.$wh.$wh1." ORDER BY ".$sidx." ". $sord." LIMIT ".$start." , ".$limit; 
      $result = mysql_query( $SQL ) or die("Couldn?t execute query.".mysql_error());
//AND substr( `fecha_inicio` , 6, 2 ) = $mes	  
    $responce->page = $page;
