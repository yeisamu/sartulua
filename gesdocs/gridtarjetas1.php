...
INNER JOIN conductor b ON a.`id_conductor` = b.`id_conductor` WHERE estado = 1 ".$wh.$wd);
...
INNER JOIN conductor b ON a.`id_conductor` = b.`id_conductor` WHERE estado = 1 ".$wh.$wd." ORDER BY ".$sidx." ". $sord." LIMIT ".$start." , ".$limit; 
