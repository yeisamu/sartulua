...
header("content-disposition: attachment;filename=reporte_tarjetas_permitidas.xls");
...
INNER JOIN conductor b ON a.`id_conductor` = b.`id_conductor` WHERE a.estado = 1 having servicio='Permitido'  ORDER BY a.estado,fecha_plazo_a asc");
?>
...
<table width="110%" border="1" align="center"  class="ui-corner-all">
   ...
   <tr >
      <td colspan="2" class="ui-corner-all " ><div align="center">RELACI&Oacute;N DE TRAJETAS PERMITIDAS</div></td>
   </tr>
   <tr >
