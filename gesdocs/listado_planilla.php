...
,search:false
		//,align:'center'	
		,hidden:true
		},{name:'accion',index:'accion',align:'left', width:150,sortable:false,search:false	
...
<table width="67%" border="1" class=" ui-corner-all  ">
  <tr class="ui-widget-header">
    ...
    <td width="37%" style="display:none">Empresa</td>
  </tr>
  <tr>
    ...
    <td class="ui-widget-content" style="display:none"><select name="grupo" id="grupo" class="ui-widget-content ui-corner-all" style="display:none">
<?php
