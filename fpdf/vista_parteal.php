...
<title>Galopin v1.0</title>
  ...
  include ("../convertirfechas2.php"); 
   $consulta = "Select * from partes,clientes where partes.codparte='$codparte' and partes.codcliente=clientes.codcliente";
...
<table width="35%" border="1" align="right" cellpadding="1" cellspacing="1" bordercolor="#0C9816">
  <tr> 
    <td width="27%" height="21" bgcolor="#0C9816"><div align="center"><font color="#FF0000" size="4" face="Verdana, Arial, Helvetica, sans-serif">PARTE ALBARANIZADO </font></div></td>
  </tr>
  <tr> 
...
<table width="60%" border="1" align="right" cellpadding="1" cellspacing="1" bordercolor="#0C9816">
  <tr bgcolor="#0C9816"> 
    ...
    <td width="22%"><div align="center"><font color="#FFFFFF"><strong><font size="2" face="Verdana, Arial, Helvetica, sans-serif">Nº Parte</font></strong></font></div></td>
  </tr>
  <tr> 
    <td><div align="center"><font size="2" face="Verdana, Arial, Helvetica, sans-serif"><? echo $lafila["nif"]; ?></font></div></td>
    <td><div align="center"><font size="2" face="Verdana, Arial, Helvetica, sans-serif"><? echo $lafila["codcliente"]; ?></font></div></td>
    <td><div align="center"><font size="2" face="Verdana, Arial, Helvetica, sans-serif"><? print reconversion($lafila["fecha"]); ?></font></div></td>
    <td><div align="center"><font size="2" face="Verdana, Arial, Helvetica, sans-serif"><? echo $lafila["codparte"]; ?></font></div></td>
  </tr>
</table>
<p>&nbsp;</p>
...
<p>
  <?
   $consulta2 = "Select * from partelinea where codparte='$codparte' order by numlinea";
...
<table width="53%" border="1" align="right" cellpadding="1" cellspacing="1" bordercolor="#0C9816">
  ...
  <tr> 
	...
	?> 		
	<div align="center"><font size="2" face="Verdana, Arial, Helvetica, sans-serif"><?=$importe3?> 
        </font> </div>
   ...
   ?>
	<td>			
	<div align="center"><font face="Verdana, Arial, Helvetica, sans-serif"><font size="2"><?=$impo; ?></font></font></div></td>
    <td>
	<?
	  $total=sprintf("%01.2f",$total);
	  $total2= number_format($total,2,",",".");  
	?> 		
	<div align="center"><font face="Verdana, Arial, Helvetica, sans-serif"><font size="2"><?=$total2; ?> 
        &euro; </font></font></div></td>
  </tr>
</table>
<p><br>
</p>
...
<center>
<form action="imprimir_parte_al.php" target="_blank">
  <input type="hidden" name="codparte" value="<?=$lafila["codparte"]; ?>">
  <input type="submit" value="Imprimir parte">
</form>
</center>
<p>&nbsp;</p></body>
</html>
