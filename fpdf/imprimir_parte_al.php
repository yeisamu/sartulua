...
$lafila=mysql_fetch_array($resultado);
    ...
    $pdf->Cell(40,65,'PARTE ALBARANIZADO');
	$pdf->SetX(10);	
	...
	$pdf->Cell(20,4,"Nº Parte.",1,0,'C',1);
	$pdf->Ln(4);
	...
	$pdf->Cell(30,4,$fecha,1,0,'C',1);	
	$pdf->Cell(20,4,$lafila["codparte"],1,0,'C',1);		
	...
	{
	  include("controlimpresionpartealb.php");
	  $pdf->Cell(1);
	  
    if (($row["codfamilia"]=='0') and ($row["codsubfamilia"]=='0')) 
	  { 
	...
	include("observacionespartealb.php");
