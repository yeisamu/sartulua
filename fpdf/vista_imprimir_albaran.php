...
<table width="35%" border="1" cellpadding="1" cellspacing="1" bordercolor="#0C9816" align="right">
  <tr> 
    <td width="27%" height="21" bgcolor="#0C9816"><div align="center"><strong><font color="#FFFFFF">ALBAR&Aacute;N</font></strong></div></td>
  </tr>
  <tr> 
...
<p>&nbsp;</p>
<center>
<form action="imprimir_albaran.php" method="post" target="_blank">
