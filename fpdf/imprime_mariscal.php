...
<div id="Layer7"><?php echo $filali["fecha_vence"]?></div>
...
<div id="Layer19"><?php $conoper="select * from veh_doc a inner join documentos_v b on a.id_documento=b.id_documento where id_movil='$id_movil' and descripcion LIKE '%OPERACION%' ";
...
<div id="Layer21"><?php $concontra="select * from veh_doc a inner join documentos_v b on a.id_documento=b.id_documento where id_movil='$id_movil' and descripcion LIKE '%CONTRACTUAL%' ";
...
<div id="Layer23"><?php $conamb="select * from veh_doc a inner join documentos_v b on a.id_documento=b.id_documento where id_movil='$id_movil' and descripcion LIKE '%AMBIENTE%' ";
