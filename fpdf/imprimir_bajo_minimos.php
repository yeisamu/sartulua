...
$pdf->SetY(50);
$pdf->SetX(0);
$pdf->MultiCell(220,6,"Listado de Articulos bajo mínimos",0,C,0);

$pdf->Ln();    

//Títulos de las columnas
$header=array('Codigo','Artículo','Proveedores','PCosto','PVP','Stock');
...
$consulta = "select * from articulos,artpro,proveedores where articulos.id=artpro.idarticulo and artpro.idproveedor=proveedores.codproveedor and articulos.stock<=articulos.bajominimo order by codfamilia,codsubfamilia,codigo";
