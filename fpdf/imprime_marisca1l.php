...
$id_doc="licencia";
/////consulta licencia
echo $conli="select * from con_doc a inner join documento b on a.id_doc=b.id_doc where id_conductor=$id_cond and documento like '%$id_doc%'";
...
<?php 
echo $consoat="select * from veh_doc a inner join documentos_v b on a.id_documento=b.id_documento where id_movil='$id_movil' and descripcion LIKE '%SOAT%' ";
...
<div id="Layer19"><?php echo $conoper="select * from veh_doc a inner join documentos_v b on a.id_documento=b.id_documento where id_movil='$id_movil' and descripcion LIKE '%OPERACION%' ";
...
<div id="Layer21"><?php echo $concontra="select * from veh_doc a inner join documentos_v b on a.id_documento=b.id_documento where id_movil='$id_movil' and descripcion LIKE '%CONTRACTUAL%' ";
...
<div id="Layer23"><?php echo $conamb="select * from veh_doc a inner join documentos_v b on a.id_documento=b.id_documento where id_movil='$id_movil' and descripcion LIKE '%AMBIENTE%' ";
$resamb= mysql_query($conamb);
$filamb=mysql_fetch_array($resamb);echo $filamb['numero']?></div>
<div id="Layer24"><?php echo $filamb['fecha_ven']?></div>
<div id="Layer25"><?php $conmovi="select * from veh_doc a inner join documentos_v b on a.id_documento=b.id_documento where id_movil='$id_movil' and descripcion LIKE '%MOVILIZACION%' ";
$resmovi= mysql_query($conmovi);
$filamovi=mysql_fetch_array($resmovi);echo $filamovi['numero']?></div>
<div id="Layer26"><?php echo $filamovi['fecha_ven']?></div>
</body>
</html>
