...
<table width="35%" border="1" align="right" cellpadding="1" cellspacing="1" bordercolor="#0C9816">
  <tr> 
    <td width="27%" height="21" bgcolor="#0C9816"><div align="center"><font color="#FFFFFF" size="4" face="Verdana, Arial, Helvetica, sans-serif">PRESUPUESTO</font></div></td>
  </tr>
  <tr> 
...
<table width="60%" border="1" align="right" cellpadding="1" cellspacing="1" bordercolor="#0C9816">
  <tr bgcolor="#0C9816"> 
    ...
    <td width="22%"><div align="center"><font color="#FFFFFF"><strong><font size="2" face="Verdana, Arial, Helvetica, sans-serif">Nº Presupuesto</font></strong></font></div></td>
  </tr>
  <tr> 
    ...
    <td><div align="center"><font size="2" face="Verdana, Arial, Helvetica, sans-serif"><? echo $lafila["codpresupuesto"]; ?></font></div></td>
  </tr>
</table>
<p>&nbsp;</p>
...
<p>
  <?
   $consulta2 = "Select * from presupuestolinea where codpresupuesto='$codpresupuesto' order by numlinea";
...
<table width="53%" border="1" align="right" cellpadding="1" cellspacing="1" bordercolor="#0C9816">
  ...
  <tr> 
	...
	?> 		
	<div align="center"><font face="Verdana, Arial, Helvetica, sans-serif"><font size="2"><? echo $total2; ?> 
...
<center>
<form action="imprimir_presupuesto.php" target="_blank">
  <input type="submit" value="Imprimir presupuesto">
