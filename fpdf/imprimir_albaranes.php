...
<form name="formul" method="post" action="imprimir_albaranes.php">
  <? if ($ini==1) {
     $error=0;
...
<table align="center">
  <tr> 
    <td width="13%" class="primeralinea">Cod. Albar&aacute;n</td>
    <td width="32%" class="primeralinea">Cliente</td>
    <td width="14%" class="primeralinea">Fecha</td>
    <td width="19%" class="primeralinea">Imprimir albar&aacute;n</td>
  </tr>
  ...
  <tr> 
    ...
    <td class="segundalinea"> 
      <font color="#FF0000"><b><? echo $lafila["codalbaran"]; ?></b></font></td>
    <td class="segundalineaizquierda"><font color="#FF0000"><? echo $lafila1["nombre"]; ?></font></td>
    <td class="segundalinea"><? echo $fech; ?></td>
    <td class="segundalinea"> 
      <form name="form2" method="post" action="vista_imprimir_albaran.php"> 
        <input type="submit" name="Submit2" value="Imprimir">
    </td>
	    <input type="hidden" name="codalbaran" value="<? echo $lafila["codalbaran"]; ?>"></form>
  </tr>
  <? } ?>
</table> 
  <? } 
  ...
  while ($i<$enlaces) { ?>
      <a href="imprimir_albaranes.php?fecha1=<? echo reconversion($fecha1); ?>&fecha2=<? echo reconversion($fecha2); ?>&campo=<? echo $campo; ?>&ordenacion=<? echo $ordenacion; ?>&codigo=<? echo $codigo; ?>&ini=1&numi=<? echo $i; ?>"><? echo $j; ?></a>
 <? $j++; 
 $i=$i+10; }
 }
