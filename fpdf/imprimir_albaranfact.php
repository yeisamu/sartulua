...
$lafila=mysql_fetch_array($resultado);
    ...
    $pdf->Cell(40,65,'ALBARÁN FACTURADO');
	$pdf->SetX(10);	
	...
	$pdf->Cell(20,4,"Nº Alb Fact.",1,0,'C',1);
	$pdf->Ln(4);
	...
	{
	  include("controlimpresionalbfact.php");
	  $pdf->Cell(1);
...
//fin de lineas de partes	
	...
	include("observacionesalbfact.php");
    ...
    $pdf->Cell(30,4,$importe4,1,0,'C',1);
	...
	$pdf->Cell(30,4,"$impo",1,0,'C',1);	
	$total=sprintf("%01.2f",$total);
	$total2= number_format($total,2,",",".");	
	$pdf->Cell(35,4,"$total2" . " €",1,0,'C',1);
	$pdf->Ln(4);
