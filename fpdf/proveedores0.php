...
<body>
<img src="../images/nuevas/impresionesalbaranesprov.jpg" alt="Impresi&oacute;n de Albaranes de Proveedor"><br>
<br>
...
<table width="100%" border="0" cellpadding="0" cellspacing="0" align="center">
  <tr bgcolor="#cddfed"> 
    <td width="6%" class="primeralinea">Cod. Albar&aacute;n</td>
    <td width="20%" class="primeralinea">Proveedor</td>
    <td width="7%" class="primeralinea">Fecha</td>
    <td width="9%" class="primeralinea">Imprimir albar&aacute;n</td>
  </tr>
  ...
  <tr> 
    ...
    <form name="form2" method="post" action="vista_albaranp.php">
      <input type="submit" name="Submit2" value="Imprimir albar&aacute;n"></td>
