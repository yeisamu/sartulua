 ...
 *  SOURCE AND OBJECT CODE FORM, AND/OR ALL RELATED MATERIALS. BY DOWNLOADING,
 *  INSTALLING, COPYING OR OTHERWISE USING THE SOFTWARE, YOU ACCEPT THE
 *  FOLLOWING TERMS AND CONDITIONS. IF YOU DO NOT AGREE WITH ANY OF THE TERMS
 *  OR CONDITIONS OF THIS LICENSE AGREEMENT, DO NOT PROCEED WITH THE
 *  DOWNLOADING, COPYING, INSTALLATION OR ANY OTHER USE OF THE SOFTWARE OR ANY
 *  PORTION THEREOF. THE SOFTWARE IS PROTECTED BY UNITED STATES COPYRIGHT LAWS
 *  AND INTERNATIONAL COPYRIGHT LAWS, AS WELL AS OTHER INTELLECTUAL PROPERTY
 ...
 *  3. DISTRIBUTION
 *
 *  You may distribute the Software in any applications (including web sites
 *  and Software-as-a-Service applications), frameworks, or elements that you
