...
//alert(movil)
 ...
 if(obs=="")mensaje+="  - Motivo del Descarte\n";
 if (mensaje!="") {
	     alert("Atenci\xF3n, Faltan los siguientes campos por Diligenciar:\n\n"+mensaje);
	}else{
...
{ 
    ...
    if(tecla == 13)
   {
      ...
      if(obs=="")mensaje+="  - Observcion\n";
      if (mensaje!="") {
	     alert("Atenci\xF3n, Faltan los siguientes campos por Diligenciar:\n\n"+mensaje);
	}else{
	   new Ajax.Updater('grabamsj','graba_serv_auto.php?id_movil='+idmov+'&idserv='+idserv+'&obs='+obs,{asynchronous: true, method: 'get',evalScripts:true});
