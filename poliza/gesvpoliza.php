...
///////grid para compañia poliza
	jQuery("#crudcomp").jqGrid({ url:'gridcomp.php',
	 datatype: "json", 
	  mtype: 'POST',
	  colNames:['Id','Compañia','NIT','Nro Poliza','Gasto Papeleria','Grupo']
	  , colModel :[
    ...
    sortorder: "asc",
    viewrecords: true,
     caption: 'Gestion de Compañia de Poliza',
	 postData: {
		customVar1:'customVal1'
		,customVar2:'customVal2'
...
<p>&nbsp;</p>
<a href="#" class="ui-state-hover Estilo1" onClick="jQuery('#compa').slideToggle();" >Compañia de poliza</a>
<p>&nbsp;</p>
<div id="compa">
