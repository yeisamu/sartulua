    ...
    <div id="message"></div>
        ...
        <form name="LoginForm<?php echo $tm; ?>" method="post" id="loginForm" action="#" autocomplete="off">
            <table width="450" cellpadding="5" cellspacing="0" border="0" id="loginTbl">
                <tr>
                    <th colspan="2">SAR TAXIS</th>
                </tr>
                <tr>
                    <td class="label" width="120"><!-- <span class="username">Usuario</span> --></td>
                    <td class="field"><input type="text" name="uname4Login"  class="inputFiled" id="username" autocomplete="off" a placeholder="Usuario" value="" /></td>
                </tr>
                <tr>
                     <td class="label"><!-- <span class="password">Password</span> --></td>
                     <td class="field"><input type="password" name="pass4Login" class="inputFiled" placeholder="Password" id="password" value="" autocomplete="off" /></td>
                </tr>
                <tr>
