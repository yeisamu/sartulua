...
jQuery("#crud10").jqGrid({ url:'grid10.php',
	 datatype: "json", 
	  mtype: 'GET',
	  colNames:['#','','Movil','Placa',' ','','Documento ','Conductor ','Fecha Acc.','Direccion Acc.','Tipo Acc','Tipo Acc','Placa Otro','Informacion','Ambulancia ','Propietario','Reportado a','Transito','Lesionados ','Placa','Entidad','Hora Asistencia','Daños Materiales','Heridos','Conciliacion','Croquis','Juez de Garantias','','Reporte Aseguradora','Observacion','Usuario']
	  , colModel :[
