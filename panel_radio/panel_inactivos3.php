...
//		editrules:required:true}
   ...
   // viewrecords: true,
	 ...
	 postData: {
		...
		//jQuery('#crud').editRow("+cl+"); 
	loadComplete: function(){
     setTimeout(function(){jQuery('#crudfre').trigger('reloadGrid')},300000) 
  ...
  //  viewrecords: true,
	 ...
	 postData: {
		...
		var rowmsj = jQuery(this).jqGrid('getRowData',cl);
		 ...
		 desc = "<a id='descarte' class='fm-button ui-state-default ui-corner-all fm-button-icon-left'  href='#' onClick=graba_des_serv("+cl+");>D<span class='ui-icon ui-icon-circle-close'></span></a>";
...
jQuery('#apropiacion').dialog({autoOpen: false, modal:true,width:250,height:160,});
jQuery('#servauto').dialog({autoOpen: false, modal:true,width:250,height:250,});
...
<div id="Layer10">
  ...
  <tr class="ui-jqgrid-titlebar ui-widget-header ui-corner-top ">
    ...
    <td width="136"  style="font-size:14px" ><div align="center">10-5</div></td>
  </tr>
  <tr class="ui-jqgrid-titlebar ui-widget-header ui-corner-top ">
...
<div id="Layer8">
  ...
  <tr class="ui-corner-all ">
	...
	<?php
	$link=conectarse();
	$conpto=mysql_query("select * from linea_atencion where id_tipo_linea=3 order by linea");
...
<table width="230" border="1" class="ui-corner-all">
  ...
  <tr class="ui-jqgrid-titlebar ui-widget-header ui-corner-top ">
    ...
    <td width="100%" style="font-size:14px"  ><div align="center">
      <input type="text" id="id_movil_auto" size="5" maxlength="5" onkeypress="Entrarauto(event);" />
	  <input type="hidden" id="idser" size="5" maxlength="5" />
    </div></td>
	 </tr>
	  <tr class="ui-jqgrid-titlebar ui-widget-header ui-corner-top ">
  
    <td width="100%" style="font-size:14px"  ><div align="center">Observaci&oacute;</div></td>
    </tr>
	  <tr class="ui-corner-all ">
<td width="100%" style="font-size:14px"  ><div align="center">
     <textarea id="observauto" onkeypress="Entrarauto(event);"></textarea>
    </div></td>
	 </tr>
