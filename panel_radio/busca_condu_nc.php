...
$select = mysql_query("select * from conductor where concat(nombre1,' ',apellido1) like '%$cadena%'");
...
array_push($items,array("id"=>$i,"label"=>$fila["nombre1"].' '.$fila["nombre2"]." ".$fila["apellido1"].' '.$fila["apellido2"],"value"=>$fila["nombre1"], ));
