...
$select = mysql_query("select * from directorio where telefono like '%$cadena%'");
...
array_push($items,array("id"=>$i,"label"=>$fila["telefono"],"value"=>$fila["telefono"],"dir"=>$fila["direccion"] ));
