...
<title>Gestion de Grupos</title>
  ...
  /*  $.jgrid.no_legacy_api = true;
	...
	jQuery("#crudgrup").jqGrid({ url:'gridpto.php',
	 datatype: "json", 
	  mtype: 'POST',
	  colNames:['Id','Ubicacion']
	  , colModel :[
    ...
    sortorder: "asc",
   //viewrecords: true,
     caption: 'Gestión de Puntos de Radio',
	 postData: {
...
<span class="Estilo1">Gesti&oacute;n de Puntos de Radio</span>
