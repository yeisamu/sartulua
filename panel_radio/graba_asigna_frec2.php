...
<div class='ui-state-error' id='errorgraba' title='Grabar Reporte de Frecuencia'>
		<span class='ui-icon ui-icon-alert' style='float:left; margin:0 7px 50px 0;'></span>
	   Reporde de Frecuencia del Movil $id_movil Grabado con exito </div><script language='javascript'>
	   ...
	   jQuery('#errorgraba').dialog({modal: true,buttons: {Ok: function() {
					jQuery( this ).dialog('close');jQuery('#frecuencia').dialog( 'close' );}}});</script>";
	}	
