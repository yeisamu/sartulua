...
<script  src="../themes/ejemplo/ui/jquery.ui.slider.js"></script>
	...
	jQuery("#f_ini" ).datetimepicker({ampm:true,
	        dateFormat:'yy-mm-dd',
			changeMonth: true,
			changeYear: true,
			showWeek: true,
...
<body onload="javascript:">
 <table width="546" border="1" align="left" cellpadding="1" class="ui-corner-all" >
  <tr>
    <td width="551"  class="ui-jqgrid-titlebar ui-widget-header ui-corner-top ui-helper-clearfix ">
      ...
      <tr class="ui-jqgrid-titlebar ui-widget-header ui-corner-top" >
		...
		<table width="100%" border="1">
            <tr>
              ...
              <td width="53" class="ui-widget-content"><input name="id_tarjeta" type="hidden" id="id_tarjeta" class="ui-widget-content ui-corner-all"  value="<?php echo $id_tarjeta ?>" />
   ...
   <tr class="ui-jqgrid-titlebar ui-widget-header ui-corner-top">
		...
		<table width="100%" border="1">
            <tr>
              ...
              <td width="36%" class="ui-widget-content"><input name="f_ini" type="text" id="f_ini" class="ui-widget-content ui-corner-all" /></td>
