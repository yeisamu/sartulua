...
session_start();
 ...
 $estado=0;
   ...
   //$eva="insert into servicio (`fecha_reg`, `linea`, `telefono`, `direccion`, `detalle_serv`, `estado`, `usuario`, `recep_serv`)VALUES(now(),'$linea','$tel','$direccion','$detalle',$estado,'$usuario',$recep)";
	   $consul=mysql_query("select estado from utilidades");
 	$sql = mysql_query("insert into servicio (`fecha_reg`, `linea`, `telefono`, `direccion`, `detalle_serv`, `estado`, `usuario`, `recep_serv`)VALUES(now(),'$linea','$tel','$direccion','$detalle',$estado,'$usuario',$recep)");
	   $consul=mysql_query("select estado from utilidades");
