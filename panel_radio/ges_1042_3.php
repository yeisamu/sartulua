...
//////grid tarjetas
	...
	jQuery("#crud1042").jqGrid({ url:'grid1042.php',
	 datatype: "json", 
	  mtype: 'GET',
	  colNames:['','Registrado','Usuario','Fecha Acc','Direccion Accidente','','Tarjeta Control','Documento','Conductor','Movil','Placa','Tipo Acc','Tipo Acc','Placa Otro','Informacion','A Johanny?','Propietario','Ambulancia','Lesionados','Transito','Tras. Lesionado','Entidad','Hora Asistencia','Daños Materiales','Heridos','Conciliacion','Croquis','Juez de Garantias','Reporte Aseguradora','Observacion','']
	  , colModel :[
   ...
   viewrecords: true,
	 ...
	 postData: {
		...
		editurl: 'grid1042.php'// this is dummy existing url 
		 ...
		 jQuery("#crud1042").jqGrid('navGrid','#pcrud1042',{search:false,edit:false,add:false,del:false,view:true},{reloadAfterSubmit:true,closeAfterEdit : true,closeOnEscape:true},{closeOnEscape:true},{closeOnEscape:true},{},{width:450,height:450});
...
jQuery("#crud10").jqGrid({ url:'grid10.php',
	 datatype: "json", 
	  mtype: 'GET',
	  colNames:['#','','Movil','Placa',' ','','Documento ','Conductor ','Fecha Acc.','Direccion Acc.','Placa','Tipo Acc','Tipo Acc','Placa Otro','Informacion','Ambulancia ','Propietario','A Johanny?','Transito','Lesionados ','Entidad','Hora Asistencia','Daños Materiales','Heridos','Conciliacion','Croquis','Juez de Garantias','','Reporte Aseguradora','Observacion','Usuario']
	  , colModel :[
   ...
   viewrecords: true,
	 ...
	 postData: {
		...
		editurl: 'grid10.php'// this is dummy existing url 
		 ...
		 jQuery("#crud10").jqGrid('navGrid','#pcrud10',{search:false,edit:false,add:false,del:false,view:true},{reloadAfterSubmit:true,closeAfterEdit : true,closeOnEscape:true},{closeOnEscape:true},{closeOnEscape:true},{},{width:450,height:450});
