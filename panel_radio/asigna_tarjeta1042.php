...
//////grid tarjetas
	...
	jQuery("#crudtar").jqGrid({ url:'gridtarjetaactiva.php?q=1&id_movil=<?php echo $id_movil?>',
	 datatype: "json", 
	  mtype: 'GET',
...
<div id="confirmar_cierre" title="Activar Frecuencia">
	<p><span class="ui-icon ui-icon-alert" style="float:left; margin:0 7px 20px 0;"></span>Esta Segur@ de poner al Movil  <span class="ui-state-error"><?php echo $id_movil?></span> en Frecuencia?</p>
</div>
