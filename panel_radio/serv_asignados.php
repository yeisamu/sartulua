...
<table width="915" border="1" cellpadding="0" cellspacing="0" class="ui-jqgrid-htable" >
	<thead>
		<tr class="ui-jqgrid-labels">
			<th width="74" class="ui-state-default ui-th-column ui-th-ltr">Telefono</th>
			<th width="214" class="ui-state-default ui-th-column ui-th-ltr">Direccion</th>
			<th width="113" class="ui-state-default ui-th-column ui-th-ltr">Detalle Servicio</th>
			<th width="66" class="ui-state-default ui-th-column ui-th-ltr">Movil</th>
			<th width="72" class="ui-state-default ui-th-column ui-th-ltr">Movil 2</th>
			<th width="116" class="ui-state-default ui-th-column ui-th-ltr">Fecha</th>
			<th width="64" class="ui-state-default ui-th-column ui-th-ltr">Usuario</th>
			<th width="178" class="ui-state-default ui-th-column ui-th-ltr">Operaciones</th>
		</tr>
	</thead>
	<tbody>
...
while($filatar=mysql_fetch_array($selectar)){
	...
	?>
		<tr class="gradeX">
			...
			<td class="flat"><input name='foo' class='flat_asig' id="deta_asig<?php echo $i ?>" onKeyPress="actualiza_dir_asig(event,<?php echo $i ?>)" value='<?php echo $filatar['detalle_serv'] ?>' size="15">
			<input  type="hidden" value='<?php echo $filatar['id_ser'] ?>' id="id_serv_asig<?php echo $i ?>"></td>
